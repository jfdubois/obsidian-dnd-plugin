...
- `npm --prefix obsidian-dnd-character run check`: passing post-P4-T014 (typecheck, lint, 2509/2509 tests across 78 files).
- `npm --prefix obsidian-dnd-character run build`: passing post-P4-T014.
- Tests: 2509 passing.
