...
- `npm --prefix obsidian-dnd-character run check`: passing post-P4-T012 (typecheck, lint, 2443/2443 tests across 73 files).
- `npm --prefix obsidian-dnd-character run build`: passing post-P4-T012.
- Tests: 2443 passing.
